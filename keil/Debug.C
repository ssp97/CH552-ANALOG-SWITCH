...
/*******************************************************************************
* Function Name  : CH552UART1RcvByte()
* Description    : CH552UART1接收一个字节
* Input          : None
* Output         : None
* Return         : SBUF
*******************************************************************************/
//UINT8  CH552UART1RcvByte( )
//{
...
/*******************************************************************************
* Function Name  : CH552UART1SendByte(UINT8 SendDat)
* Description    : CH552UART1发送一个字节
* Input          : UINT8 SendDat；要发送的数据
* Output         : None
* Return         : None
*******************************************************************************/
//void CH552UART1SendByte(UINT8 SendDat)
//{
